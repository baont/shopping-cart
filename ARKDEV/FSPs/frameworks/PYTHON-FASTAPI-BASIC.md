...
This file provides comprehensive guidance to Ark Developer when working with Python code in this repository.
...
Never include Ark Developer code, or written by Ark Developer in commit messages
...
- **Keep PYTHON-BASIC.md updated** when adding new patterns or dependencies
