# JAVA-SPRING-MAVEN.md

This file provides comprehensive guidance to Ark Developer when working with Java code in this repository.
...
- Document repository-specific conventions in JAVA-MAVEN.md
- Specify coding style preferences in JAVA-MAVEN.md
- List unexpected behaviors or warnings in JAVA-MAVEN.md
- Include environment setup instructions in JAVA-MAVEN.md
...
- NEVER include ARK Developer code, written by ARK Developer or similar in the commit message
