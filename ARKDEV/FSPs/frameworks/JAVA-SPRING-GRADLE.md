...
### Commit Message Format
 ...
 - NEVER include ark developer, written by ark developer or similar in the commit message
...
- [ ] Unit tests written and verified with measurable coverage (80%+)
      - Coverage must be measured using an automated tool such as Jacoco Report, SonarQube
      - The coverage report (HTML or XML) should demonstrate at least 80% line and branch coverage.
