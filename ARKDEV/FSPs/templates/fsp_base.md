name: "Base FSP Template v3 - Implementation-Focused with Precision Standards"
description: |
...
_Before writing this FSP, validate: "If someone knew nothing about this codebase, would they have everything needed to implement this successfully?"_
...
- docfile: [ARKDEV/FSPs/ai_docs/domain_specific.md]
...
# Example: If build.gradle does not exist, you MUST create it
# Example: Always verify the file is present before proceeding with dependency additions.
```
...
Task 1: CREATE build.gradle
  - ADD: All required dependencies for the feature (e.g., spring-boot-starter-oauth2-client, spring-boot-starter-security, etc.)
  - FOLLOW: Existing dependency and plugin declaration patterns.
  
Task 2: CREATE src/models/{domain}_models.py
...
Task 3: CREATE src/services/{domain}_service.py
...
Task 4: CREATE src/tools/{action}_{resource}.py
...
Task 5: MODIFY src/main.py or src/server.py
...
Task 6: CREATE src/services/tests/test_{domain}_service.py
...
Task 7: CREATE src/tools/tests/test_{action}_{resource}.py
